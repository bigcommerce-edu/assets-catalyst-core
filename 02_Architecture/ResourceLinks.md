# Key Architecture - Resource Links
...
* [Next.js Data Cache](https://nextjs.org/docs/app/guides/caching-without-cache-components)
* [Streaming with Suspense](https://nextjs.org/docs/app/api-reference/file-conventions/loading)
